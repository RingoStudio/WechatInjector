...
namespace RS_WX_INJECTOR.utils
{
    public class INIHelper
    {
        ...
        private static string iniPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "BOT\\injector.ini");
        /// <summary>
        /// 为INI文件中指定的节点取得字符串
        /// </summary>
        ...
        public static string Read(string section, string key, string def, string filePath = "")
        {
            ...
            if (string.IsNullOrEmpty(filePath)) filePath = iniPath;
